...
//     pub transport_id: Option<Address>,
// }
...
//         }
//         if header.header_type != addresses.header_type() {
...
//         }
//         if let Some(transport_id) = self.addresses.transport_id {
//             out.extend_from_slice(&transport_id);
//         }
//         out.extend_from_slice(&self.addresses.destination_hash);
...
//             HeaderType::Type1 => {
//                 let mut destination_hash = [0u8; ADDR_LEN];
//                 destination_hash.copy_from_slice(&bytes[pos..pos + ADDR_LEN]);
//                 Addresses {
//                     destination_hash,
//                     transport_id: None,
//                 }
//             }
//             HeaderType::Type2 => {
//                 let mut transport_id = [0u8; ADDR_LEN];
//                 let mut destination_hash = [0u8; ADDR_LEN];
//                 transport_id.copy_from_slice(&bytes[pos..pos + ADDR_LEN]);
//                 destination_hash.copy_from_slice(&bytes[pos + ADDR_LEN..pos + 2 * ADDR_LEN]);
//                 Addresses {
//                     destination_hash,
...
//         let addr_len = if self.addresses.transport_id.is_some() {
//             2 * ADDR_LEN
//         } else {
//             ADDR_LEN
//         };
...
//             None,
//             Addresses {
//                 destination_hash: hash2,
//                 transport_id: Some(hash1),
//             },
//             Context::None,
//             data.clone(),
//         )
